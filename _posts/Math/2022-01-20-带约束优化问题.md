...
### 1.2 拉格朗日乘子法 (Lagrange Multiplier Method)
...
### 3.5 序列二次规划法 (Sequential Quadratic Programming, SQP)
...
#### 4.2.2 内点法 (Interior Point Method)
...
#### 4.2.3 对偶单纯形法 (Dual Simplex Method)
...
#### 4.2.5 切割平面法 (Cutting Plane Method)
...
### 5.7 梯度投影法（Gradient Projection Method）
   - 计算无约束问题的梯度
   - 将梯度投影到可行域
   - 使用线搜索确定步长
   - 优点：实现简单
